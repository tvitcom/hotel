...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'serviceflow_id'); ?>
		<?php echo $form->textField($model,'serviceflow_id',array('size'=>21,'maxlength'=>21)); ?>
		<?php echo $form->error($model,'serviceflow_id'); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'payment',array('size'=>11,'maxlength'=>11)); ?>
