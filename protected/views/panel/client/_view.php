...
<div class="view">
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('voicecall')); ?>:</b>
	<?php echo CHtml::encode($data->voicecall); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('user_sert')); ?>:</b>
	<?php echo CHtml::encode($data->user_sert); ?>
	<br />
