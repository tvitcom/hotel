...
--
-- Хост: localhost
-- Время создания: Дек 28 2015 г., 16:10
...
CREATE TABLE IF NOT EXISTS `clients` (
  ...
  `fullname` varchar(64) NOT NULL COMMENT 'Full Name',
  `username` varchar(64) NOT NULL COMMENT 'username',
  `passhash` varchar(64) NOT NULL COMMENT 'pass_hash',
  ...
  `privs` text NOT NULL COMMENT 'Priveleges',
...
INSERT INTO `price` (`id`, `hotels_id`, `name`, `marketing_descr`, `description`, `price`, `price_unit`, `in_currency`, `is_active`) VALUES
(1, 1, 'Завтрак в номер', 'Свежеприготовленное чтонибудь', 'Самые свежие фрукты с барабашова!!!', 100.00, '1', 'UAH', 1),
(2, 1, 'Обед в номер', 'Вкусненькое что нибудь на обед - обязательно отведайте:)!!!', 'Вкусненькое что нибудь', 150.00, '1', 'UAH', 1);
...
CREATE TABLE IF NOT EXISTS `visits` (
  `id` bigint(21) unsigned NOT NULL AUTO_INCREMENT,
  `discount_id` bigint(21) unsigned NOT NULL,
  `visiter_id` bigint(21) unsigned NOT NULL,
  `room_id` bigint(21) unsigned NOT NULL,
  `serviceflow_id` bigint(21) unsigned NOT NULL,
  ...
  KEY `fk_visits_discounts1_idx` (`discount_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
ALTER TABLE `visits`
  ADD CONSTRAINT `fk_visits_discounts1` FOREIGN KEY (`discount_id`) REFERENCES `discounts` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
